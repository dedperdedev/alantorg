...
export const vacancies: Vacancy[] = [
  { id: '1', title: 'Приёмщик дикоросов', city: 'Архангельск', type: 'seasonal', schedule: 'Полный день', salary: 'от 45 000 Br', description: 'Приёмка, сортировка и учёт ягод и грибов на пункте', requirements: ['Опыт работы от 1 года', 'Знание видов дикоросов', 'Ответственность'], conditions: ['Официальное оформление', 'Питание', 'Сезон: июнь–октябрь'] },
  { id: '2', title: 'Водитель-экспедитор', city: 'Вологда', type: 'seasonal', schedule: 'Вахта 15/15', salary: 'от 60 000 Br', description: 'Перевозка дикоросов между пунктами приёма и складом', requirements: ['Категория B/C', 'Стаж от 3 лет', 'Знание региона'], conditions: ['Проживание', 'ГСМ компании', 'Премии'] },
  { id: '3', title: 'Менеджер по закупкам', city: 'Москва', type: 'permanent', schedule: 'Полный день', salary: 'от 80 000 Br', description: 'Работа с поставщиками дикоросов, ценообразование, контроль качества', requirements: ['Опыт в закупках', 'Знание рынка дикоросов', 'Аналитические навыки'], conditions: ['Офис в центре', 'ДМС', 'Бонусы по KPI'] },
  ...
  { id: '5', title: 'Контролёр качества', city: 'Архангельск', type: 'permanent', schedule: 'Полный день', salary: 'от 50 000 Br', description: 'Контроль качества принимаемой продукции на складе', requirements: ['Образование в пищевой промышленности', 'Внимательность'], conditions: ['Стабильный график', 'Соцпакет'] },
];
